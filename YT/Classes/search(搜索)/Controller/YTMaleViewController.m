...
@interface YTMaleViewController () <YTRightMenuCell>
...
@implementation YTMaleViewController
...
- (void)setUpData
{
    for (int i=0; i<self.maleArr.count; i++) {
        if (i>0 && i<9) {
            YTModel *model = self.maleArr[i];
